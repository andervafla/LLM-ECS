...
resource "aws_ecs_task_definition" "ollama_openwebui" {
  family                   = "ollama-openwebui-task"
  network_mode             = "awsvpc"
...
resource "aws_ecs_service" "ollama_openwebui" {
  name            = "ollama-openwebui-service"
  cluster         = aws_ecs_cluster.main.id
  task_definition = aws_ecs_task_definition.ollama_openwebui.arn
  desired_count   = 1
  launch_type     = "FARGATE"
